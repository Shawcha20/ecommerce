            ...
            <div class="col-md-6 col-md-offset-3">
                <div class="panel panel-default credit-card-box">
                    ...
                    <div class="panel-body">
                        ...
                        <form action="{{ route('buy.cart', ['user' => $user->id]) }}" method="post" id="payment-form">
                            @csrf
                            ...
                            <div class='form-row row'>
                                <div class='col-xs-12 form-group card required'>
                                    ...
                                    <input class='form-control card-number' size='20' type='text' name="card_number">
                                </div>
                            </div>
                            ...
                            <div class='form-row row'>
                                <div class='col-xs-12 col-md-4 form-group cvc required'>
                                    ...
                                    <input class='form-control card-cvc' placeholder='ex. 311' size='4' type='text'>
                                </div>
